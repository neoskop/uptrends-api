import { RequestAPI, Request as RequestRequest, RequestResponse, CoreOptions, RequiredUriUrl } from 'request';
...
export class Request implements IRequest {
    ...
    constructor({ baseUrl = 'https://api.uptrends.com/v3', username, password } : IRequestConfig) {
    ...
    protected request<T>(method : string, path : string, body? : object) : Promise<T> {
